...
if Selected=="NLP Detailing":
    ...
    text_data=[#("She was struggling with depression, and her thoughts turned to suicide","Negative"),
                ("I am suffering from post-traumatic-stress-disorder","Positive"),
                ("I enjoyed swimming in the pool","Positive"),
                ("I read newspaper today","Positive"),
                ("I am riding bicycle","Positive"),
                ("I am suffering from depression","Negative"),
                ("NLP can be difficult for beginners","Negative"),
                ("I Dislike the weather in chennai","Negative")]
...
if Selected =="Customer Recomendation":
    ...
    def load_data():
        ...
        datapath="/content/market_data.csv"
